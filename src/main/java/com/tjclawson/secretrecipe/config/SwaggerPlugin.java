...
public class SwaggerPlugin implements ApiListingScannerPlugin {

    private final CachingOperationNameGenerator operationNames;

    public SwaggerPlugin(CachingOperationNameGenerator operationNames) {
    ...
    public List<ApiDescription> apply(DocumentationContext documentationContext) {
        return new ArrayList<>(Arrays.asList(
                new ApiDescription(null,
                        "/login",
                        "login",
                        Arrays.asList(new OperationBuilder(operationNames)
